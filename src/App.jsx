...
const SEED_DRAFTS = [
  ...
  },
  {
    ...
    votes:{},
    totals:{"Tom":17,"Joe":19,"OP":7,"Talal":15,"Cat":12,"Scott":21},
    seasonPoints:{"Tom":0,"Joe":0,"OP":0,"Talal":0,"Cat":0,"Scott":3},
    winner:"Scott",
  },
  {
    id:"d4", category:"Best Feelings", season:1, week:4, status:"voted",
    drafters:["Joe","OP","Scott","Talal","Cat","Tom"],
    numPicks:3,
    picks:{
      "Joe":["True Love","When a puppy falls asleep on you","Winning a championship"],
      "OP":["Shower after a beach day","Getting in bed w/ clean sheets post-shower","Seeing people out that you didn't expect"],
    ...
    votes:{},
    totals:{"Joe":11,"OP":22,"Scott":15,"Talal":26,"Cat":23,"Tom":14},
    seasonPoints:{"Joe":0,"OP":1,"Scott":0,"Talal":3,"Cat":2,"Tom":0},
    winner:"Talal",
  },
  {
    id:"d5", category:"Months", season:1, week:5, status:"voted",
    drafters:["OP","Joe","Talal","Tom"],
    numPicks:3,
    picks:{
      "OP":["May","August","September"],
      "Joe":["December","April","November"],
      "Talal":["July","October","March"],
      "Tom":["January","June","February"],
    },
    votes:{},
    totals:{"OP":16,"Joe":14,"Talal":18,"Tom":6},
    seasonPoints:{"OP":2,"Joe":0,"Talal":3,"Tom":0},
    winner:"Talal",
  },
  {
    id:"d6", category:"Candies", season:1, week:6, status:"voted",
    drafters:["Joe","Scott","Cat","OP"],
    numPicks:3,
    picks:{
      ...
      "OP":["Mike and Ike's Sour","Twix","Jolly Ranchers"],
    },
    votes:{},
    totals:{"Joe":13,"Scott":12,"Cat":10,"OP":9},
    seasonPoints:{"Joe":3,"Scott":2,"Cat":1,"OP":0},
    winner:"Joe",
  },
  {
    id:"d7", category:"Childhood TV Shows", season:1, week:7, status:"voted",
    drafters:["OP","Tom","Joe","Cat","Scott","Talal"],
    numPicks:3,
    picks:{
      "OP":["Drake & Josh","Zoey 101","That's So Raven"],
    ...
    votes:{},
    totals:{"OP":13,"Tom":18,"Joe":12,"Cat":12,"Scott":10,"Talal":0},
    seasonPoints:{"OP":2,"Tom":3,"Joe":0,"Cat":0,"Scott":0,"Talal":0},
    winner:"Tom",
  },
  {
    id:"d8", category:"Worst Corporate Buzzwords", season:1, week:8, status:"voted",
    drafters:["Tom","Scott","OP","Cat","Joe"],
    numPicks:3,
    picks:{
    ...
    votes:{},
    totals:{"Tom":7,"Scott":6,"OP":12,"Cat":10,"Joe":15},
    seasonPoints:{"Tom":0,"Scott":0,"OP":2,"Cat":1,"Joe":3},
    winner:"Joe",
  },
  {
